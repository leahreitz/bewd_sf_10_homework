...
class Apartment #create the apartment class
	...
	def initialize(name, footage, bedrooms, bathrooms) #the primary job of initialize is creating an instance, build a constructor with our required attributes
...
#renter class with credit score and annual salary