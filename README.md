...
| 13         | Complete Artist model & controllers. If you complete Artist, try creating Song. Take a stab at the [controller](http://guides.rubyonrails.org/action_controller_overview.html) and view layers. | [13_Rails_Intro_Model_Associations_Validations](https://github.com/ga-students/bewd_sf_10/tree/master/13_Rails_Intro_Model_Associations_Validations) <br>  | Monday, September 21st | Wednesday, September 23rd |
| 14         |            | - | - | - |
| ...        |            | - | - | - |
