...
class ZoosControllerTest < ActionController::TestCase
  ...
  test "should create zoo" do
    assert_difference('Zoo.count') do
      post :create, zoo: { age: @zoo.age, animal_type: @zoo.animal_type, available: @zoo.available, image: @zoo.image, name: @zoo.name }
    end
  ...
  test "should update zoo" do
    patch :update, id: @zoo, zoo: { age: @zoo.age, animal_type: @zoo.animal_type, available: @zoo.available, image: @zoo.image, name: @zoo.name }
    assert_redirected_to zoo_path(assigns(:zoo))
  end
